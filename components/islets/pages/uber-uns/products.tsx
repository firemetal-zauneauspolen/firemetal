export function ProductsUberUns() {
  return (
    <>
      <section className="z-30 mt-8 flex flex-col items-center justify-center">
        ...
        <p className="z-30 pt-2 text-center md:px-12 xl:text-xl 2xl:px-52">
          ...
          Gartendekorationen, Gartenzäune, Schaukeln, Gartenbänke, Tische und
          Pergolen. Alle unsere Produkte werden aus Materialien höchster
          Qualität hergestellt, was ihre Haltbarkeit und Wetterbeständigkeit
          garantiert.
        </p>
      </section>
    </>
